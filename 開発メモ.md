...
```
jyosetu  14060  2592 99 11:33 pts/3    00:20:59 python sv.py
jyosetu  20067 19291  0 11:55 pts/4    00:00:00 grep --color=auto sv.py
```

2. プロセスIDを指定して終了させる

プロセスの検索で、`jyosetu  14060  2592 99 11:33 ...` と表示されたら、最初の番号の `14060` がプロセスID
